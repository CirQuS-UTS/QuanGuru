...
from qTools.QuantumToolbox.operators import sigmaz, number, sigmam, sigmap, create, destroy, sigmax
...
def JC(obj, subSys1, subSys2, cStrength):
    ...
    if qsystems[1].operator == sigmaz:
        print('sigmaz')
        couplingObj = obj.createSysCoupling(qsystems, [destroy, sigmap], superSys=obj, couplingStrength=cStrength)
