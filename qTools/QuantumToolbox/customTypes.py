...
Matrix = Union[spmatrix, ndarray]                   # Type which is either spmatrix or nparray (created using TypeVar) #pylint:disable=unsubscriptable-object
...
supInp = Union[Dict[int, float], intList, int]      # Type from the union the types int, intList, and dict[int;float] #pylint:disable=unsubscriptable-object

#: Type from the union of ndarray and intList with integer elements
ndOrListInt = Union[ndarray, intList]              # Type from the union of ndarray and intList with integer elements #pylint:disable=unsubscriptable-object
