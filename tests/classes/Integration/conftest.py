...
class _twoQubitsExchange:
    ...
    @staticmethod
    def c10(rbf, c10inp, c01inp, detun, cStg, t=0): return (c_1(rbf, c10inp, c01inp, detun, cStg)*((rbf-detun)/(2*cStg)))*np.exp(-1j*rbf*t/2) - (c_2(rbf, c10inp, c01inp, detun, cStg)*((rbf+detun)/(2*cStg)))*np.exp(1j*rbf*t/2)
    @staticmethod
    def c01(rbf, c10inp, c01inp, detun, cStg, t=0): return (c_1(rbf, c10inp, c01inp, detun, cStg)*np.exp(-1j*rbf*t/2) + c_2(rbf, c10inp, c01inp, detun, cStg)*np.exp(1j*rbf*t/2))
    @staticmethod
