...
def test_QTermCreateTerm():
    ...
    t1 = QTerm._createTerm(named1, named1, sigmaz, orders=2, frequency=3)
    ...
    t1 = QTerm._createTerm(named1, [named1, named2, named3, named4], [sigmaz,sigmaz, sigmay, sigmax], orders=[0, 1, 2, 3], frequency=4)
